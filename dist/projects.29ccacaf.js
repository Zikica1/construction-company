...
})({"8at8Z":[function(require,module,exports) {
...
async function load() {
    const page = await require("938fcda66d941873");
    page.render();
}
load();
...
window.addEventListener("scroll", ()=>{
    ...
    modalContent.forEach((modalContent)=>{
        if (currentScroll <= 0) modalContent.classList.remove("sticky-up");
...
},{"938fcda66d941873":"lKe1w"}],"lKe1w":[function(require,module,exports) {
module.exports = require("f582f00679fcaa43")(require("785a4a88994b66a2").getBundleURL("fAGJZ") + "global.6c9f5b79.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("ivXNZ"));

},{"f582f00679fcaa43":"61B45","785a4a88994b66a2":"lgJ39"}],"61B45":[function(require,module,exports) {
"use strict";
var cacheLoader = require("1264ae21b9b26bb8");
...
},{"1264ae21b9b26bb8":"j49pS"}],"j49pS":[function(require,module,exports) {
"use strict";
var cachedBundles = {};
var cachedPreloads = {};
...
},{}]},["8at8Z","82j8t"], "82j8t", "parcelRequire26af")
