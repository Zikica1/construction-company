...
})({"99GTO":[function(require,module,exports) {
...
async function load() {
    const page = await require("e74370d4ad1ef294");
    page.render();
}
load();
...
},{"e74370d4ad1ef294":"bcVTZ"}],"bcVTZ":[function(require,module,exports) {
module.exports = require("4d16073159b3e6df")(require("7a3df52eeaeac191").getBundleURL("1Vv9e") + "global.6c9f5b79.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("ivXNZ"));

},{"4d16073159b3e6df":"61B45","7a3df52eeaeac191":"lgJ39"}],"61B45":[function(require,module,exports) {
"use strict";
...
},{}]},["99GTO","3C9CX"], "3C9CX", "parcelRequire26af")
