...
async function load() {
    const page = await require("dfc30c5f2b596d63");
    page.render();
}
load();
...
},{"dfc30c5f2b596d63":"kePhp"}],"kePhp":[function(require,module,exports) {
module.exports = require("f0747b0f58243822")(require("58892025e92ab6cb").getBundleURL("g05j8") + "global.6c9f5b79.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("ivXNZ"));

},{"f0747b0f58243822":"61B45","58892025e92ab6cb":"lgJ39"}],"61B45":[function(require,module,exports) {
"use strict";
